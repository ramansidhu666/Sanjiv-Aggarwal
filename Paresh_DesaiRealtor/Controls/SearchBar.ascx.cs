...
namespace Property.Controls
{
    ...
    { 
        ...
        {
            if (ddlPropType.SelectedValue.ToString() == "Residential")
            {
                ddlPropertyType.Visible = true;
                ddlPropertyType_comm.Visible = false;
                ddlPropertyType_condo.Visible = false;

            }
            else if (ddlPropType.SelectedValue.ToString() == "Commercial")
            {
                ddlPropertyType.Visible = false;
                ddlPropertyType_comm.Visible = true;
                ddlPropertyType_condo.Visible = false;
            }
            else if (ddlPropType.SelectedValue.ToString() == "Condo")
            {
                ddlPropertyType.Visible = false;
                ddlPropertyType_comm.Visible = false;
                ddlPropertyType_condo.Visible = true;
            }
        }
