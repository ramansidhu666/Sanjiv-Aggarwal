            ...
            <div style="float: left; width: 100%; background: white; border-radius: 6px; padding:10px;">
                ...
                <div style="float: left; width: 100%; margin-bottom: 12px;">
                    ...
                    <div style="float: left; width: 33%; margin-top: 20px;">
                        <h2 style="margin-bottom: 5px; font-family:arial; font-size: 18px;">Aggarwal Realty</h2>
                        <p style="margin-bottom: 5px; font-family:arial;">Sales Representatives</p>
                        <p style="font-weight: bold; margin-bottom: 5px; font-family:arial;">E-Mail:<span style="font-weight: normal; margin: 0 0px 0 6px;">info@aggarwalrealty.ca</span></p>
                        <p style="font-weight: bold; margin-bottom: 5px; font-family:arial;">Phone:<span style="font-weight: normal; margin: 0 0px 0 6px;">416-409-9090</span></p>
                    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content new_pop">
                ...
                <div class="modal-body modl_bg">
                    ...
                    <p>By entering my contact information i give my express consent to be contacted by 'HomeLife/Miracle Realty Ltd., Brokerage* and or real estate salespeople on bahalf of Royal LePage Flower City Realty Inc, Brokerage*' to discuss potential services.</p>
                </div>
                </div>
