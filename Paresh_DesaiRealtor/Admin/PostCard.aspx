...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.btnSavePostcard1').css('display', 'block')
            $('.btnSavePostcard2').css('display', 'none')
            $('.btnSavePostcard3').css('display', 'none')
            $('.btnSavePostcard4').css('display', 'none')
            //Slider work
            ...
            $("#Openhouse_click li").click(function () {
                ...
                if (id == "Openhouse") {
                    ...
                    Hide_2ndFtr();
                    Hide_jstsold();
                    $('.btnSavePostcard1').css('display', 'none')
                    $('.btnSavePostcard2').css('display', 'block')
                    $('.btnSavePostcard3').css('display', 'none')
                    $('.btnSavePostcard4').css('display', 'none')
                    $('#<%=hdnTemplateType.ClientID %>').val(id)
                 }
                     ...
                     $('.btnSavePostcard1').css('display', 'none')
                     $('.btnSavePostcard2').css('display', 'none')
                     $('.btnSavePostcard3').css('display', 'block')
                     $('.btnSavePostcard4').css('display', 'none')
                     $('#<%=hdnTemplateType.ClientID %>').val(id)
                }
                else if (id == "jst_sold") {
                    ...
                    $('.btnSavePostcard2').css('display', 'none')
                    $('.btnSavePostcard3').css('display', 'none')
                    $('.btnSavePostcard4').css('display', 'block')
                    $('#<%=hdnTemplateType.ClientID %>').val(id)
                }
            });
            ...
            $('#property_photo_div').click(function () {
             ...
             $('#property_photo_div2').click(function () {
                var id = $(this).data("id");
                OpenFeaturFirstmodel(id)
            }
          )
...
function Change_src_opnhouse(e, id) {
    ...
    if (id == "openhousefile2") {
        $('#property_photo2').attr('src', e.target.result);
    }
}
...
function Hide_Show_opn_browsebtns(id) {
    ...
    $('#<%=openhousefile.ClientID %>').css('display', 'none')
      $('#<%=openhousefile2.ClientID %>').css('display', 'none')
    //display browse button on click
    if (id == "openhouse") {
        $('#<%=openhousefile.ClientID %>').css('display', 'block')
    }
     if (id == "openhouse2") {
        $('#<%=openhousefile2.ClientID %>').css('display', 'block')
    }
}
...
function htmldata(data) {
    ...
    if ($('#<%=hdnTemplateType.ClientID %>').val() == "Openhouse") {
       ...
       // var firstimg2 = $('#property_photo2').attr('src');
        var secondimg = $('#property_photo2').attr('src');
        returnhtml = returnhtml.replace("{firstimg}", firstimg);
        returnhtml = returnhtml.replace("{secondimg}", secondimg);
        //returnhtml = returnhtml.replace("{firstimg2}", firstimg2);
    }
...
function PostCard_Data() {
    ...
    if ($('#<%=hdnTemplateType.ClientID %>').val() == "Openhouse") {
        ...
        var thirldcontent = $('#<%=ThirdContent.ClientID %>').val();
                var DESC = $('#<%=txtDesc1.ClientID %>').val();
        data = "{FirstContent: '" + firstcontent + "', SecondContent: '" + secondcontent + "', ThirldContent: '" + thirldcontent + "', Desc: '" + DESC + "'}";
    }
    else if ($('#<%=hdnTemplateType.ClientID %>').val() == "feature") {
        ...
        var Fourth_feature_cntnt = $('#<%=Fourth_feature_cntnt.ClientID %>').val();
         var DESC = $('#<%=txtDesc2.ClientID %>').val();
        data = "{First_feature_cntnt: '" + First_feature_cntnt + "', Second_feature_cntnt: '" + Second_feature_cntnt + "', Thirld_feature_cntnt: '" + Thirld_feature_cntnt + "', Fourth_feature_cntnt: '" + Fourth_feature_cntnt + "', Desc: '" + DESC + "'}";
    }
    else if ($('#<%=hdnTemplateType.ClientID %>').val() == "2ndfeature") {
        $('#mypopup').addClass('scnd_postcard');
        ...
        var Fourth_feature_cntnt = $('#<%=ftr_2nd_4thcntnt.ClientID %>').val();
           var DESC = $('#<%=txtDesc3.ClientID %>').val();
        data = "{First_feature_cntnt: '" + First_feature_cntnt + "', Second_feature_cntnt: '" + Second_feature_cntnt + "', Thirld_feature_cntnt: '" + Thirld_feature_cntnt + "', Fourth_feature_cntnt: '" + Fourth_feature_cntnt + "', Desc: '" + DESC + "'}";
    }
    else if ($('#<%=hdnTemplateType.ClientID %>').val() == "jst_sold") {
        $('#mypopup').addClass('scnd_postcard');
            ...
            <div class="module-body">
                ...
                <div class="form-horizontal row-fluid">
                        ...
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            ...
                            <div style="float: left; width: 100%; background-color: white; border-radius: 12px; margin: 22px 0 12px;">
                              <div style="float: left; width: 100%; margin: 12px 0; text-align: center;">
                                  ...
                                  <asp:TextBox ID="FirstContent" MaxLength='40' onkeyDown="checkTextAreaMaxLength(this,event,'40');" Style="float: left; box-shadow: none; margin: 12px 0 0; width: 100%; color: #733b09; font-family: Arial, Helvetica, sans-serif; font-size: 26px; text-align: center; border: none; font-weight: bold;" runat="server" PlaceHolder="Description here..." class="span8">Wednesday, MAY 16 12:30 </asp:TextBox>
                                </div>
                                ...
                                <div style="float: left; width: 100%; margin: 6px 0 18px 0; text-align: center;">
                                    ...
                                    <asp:TextBox ID="SecondContent" MaxLength='40' onkeyDown="checkTextAreaMaxLength(this,event,'40');" Style="float: left; box-shadow: none; width: 100%; color: #733b09; font-family: Arial, Helvetica, sans-serif; font-size: 26px; font-weight: bold; text-align: center; border: none; margin: 12px 0;" runat="server" PlaceHolder="Description here..." class="span8">Wednesday, MAY 16 12:30 </asp:TextBox>
                                </div>
                            </div>
                    ...
                    <div class="newsltr_bg" id="backside_page" style="display: none">
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            ...
                            <div style="float: left; width: 97%; background-color: white; border-radius: 12px; padding: 12px; margin: 10px 0;">
                                ...
                                <asp:TextBox ID="txtDesc1" MaxLength='300' onkeyDown="checkTextAreaMaxLength(this,event,'300');" Style="float: left; box-shadow: none; width: 100%; color: #733b09; font-family: Arial, Helvetica, sans-serif; font-size: 26px; font-weight: bold; text-align: center; border: none; margin: 12px 0;" runat="server" PlaceHolder="" class="span8">
                                </asp:TextBox>
                            ...
                            <div style="float: left; width: 40%; text-align: center; margin: 8px 0;">
                              <%--  <div id="second_imag" style="float: left; width: 100%;">
                                  ...
                                  <div id="property_photo_div2" data-id="openhouse2" style="float: left; width: 127%; text-align: center; margin: 8px 0;">
                                    <img id="property_photo2" src="../PostCardImages/open_house_img2.jpg" alt="" title="" style="border-radius: 14px; border: 2px solid white; width: 78%; " />
                                </div>
                            </div>
                            <div style="float: left; width: 60%; text-align: center; margin: 8px 0;">
                                <div style="float: left; width: 100%; text-align: center;">
                                    ...
                                    <h2 style="float: left; margin: 6px 0; text-align: center; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 20px; font-weight: bold;">Sanjiv & Meena Aggarwal</h2>
                    <p style="float: left; text-align: center; margin: 2px 0; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">P: 416-409-9090</p>
                    <p style="float: left; text-align: center; width: 100%; margin: 2px 0; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 16px;">realtor.aggarwal@gmail.com | www.aggarwalrealty.ca/</p>
                   ...
                   <div style="float: right;margin-top: 10px;">
                          <asp:Button  ID="btnSavePostcard1" class="btn btn-primary btnSavePostcard1" Text="Save" runat="server" OnClick="btnSavePostcard1_Click" />
                    </div>
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0;">
                                ...
                                <div style="float: left; width: 65%;">
                                    <div style="float: left; background-color: #e8eaec; border-radius: 12px; padding: 12px;">
                                        <h2 style="float: left; width: 100%; color: #1c1c1c; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;">Sanjiv & Meena Aggarwal</h2>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 416-409-9090</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: realtor.aggarwal@gmail.com</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.aggarwalrealty.ca/</p>
                        ...
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                                ...
                                <div style="float: left; width: 100%; margin: 12px 0;">
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div id="featured_second_imge" data-id="featured_second" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_second_img" src="../PostCardImages/featrd_img1_back.jpg" alt="" title="" style="width: 100%; height:250px; border: 2px solid white;" />
                                        </div>
                                        <div id="featured_thirld_imge" data-id="featured_thirld" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_thirld_img" src="../PostCardImages/featrd_img2_back.jpg" alt="" title="" style="width: 100%;  height:250px; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div id="featured_fourth_imge" data-id="featured_fourth" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_fourth_img" src="../PostCardImages/featrd_img3_back.jpg" alt="" title="" style="width: 100%;  height:250px; border: 2px solid white;" />
                                        </div>
                                        <div id="featured_fifth_imge" data-id="featured_fifth" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_fifth_img" src="../PostCardImages/featrd_img4_back.jpg" alt="" title="" style="width: 100%;   height:250px; border: 2px solid white;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="float: left; width: 100%; margin: 12px 0; text-align: center;">
                               <%-- <h2 style="float: left; width: 100%; font-family: 'Times New Roman', Times, serif; font-weight: bold; font-style: italic; font-size: 28px; color: #161616;">Add your description here</h2>
                                ...
                                <asp:TextBox ID="txtDesc2" MaxLength='300' onkeyDown="checkTextAreaMaxLength(this,event,'300');"  Style="float: left; box-shadow: none; width: 100%; color: #733b09; font-family: Arial, Helvetica, sans-serif; font-size: 26px; font-weight: bold; text-align: center; border: none; margin: 12px 0;" runat="server"  PlaceHolder="" class="span8">
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Sanjiv & Meena Aggarwal (Sales Representatives)</h2>
                    ...
                    <%--End Featured postcard functionality--%>
                      <div style="float: right;margin-top: 10px;">
                          <asp:Button ID="btnSavePostcard2" class="btn btn-primary btnSavePostcard2" Text="Save" runat="server" OnClick="btnSavePostcard2_Click" />
                    </div>

                    <%--Second featured postacard functionality--%>
                    <div class="newsltr_bg" id="2nd_featured_front" style="display: none;">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px 0px;">
                            ...
                            <div style="float: left; width: 100%;" id="2nd_ftr_fstimg" data-id="2nd_ftr_fstimg">
                                <img id="ftr_2nd_1stimge" src="../PostCardImages/featrd_img1_postcard3.png" alt="" title="" style="width:100%; max-height:350px;" />
                            </div>
                            ...
                            <div style="float: left; width: 97%; margin: 12px 0; background-color: #e3e3e3; padding: 6px; border-radius: 8px;">
                                <div style="float: left; width: 100%; margin: 12px 0; text-align: center;">
                                    <asp:TextBox ID="txtDesc3" MaxLength='900' onkeyDown="checkTextAreaMaxLength(this,event,'900');" Style="float: left; box-shadow: none; width: 100%; color: #733b09; font-family: Arial, Helvetica, sans-serif; font-size: 26px; font-weight: bold; text-align: center; border: none; margin: 12px 0;" runat="server"  PlaceHolder="" class="span8">
                    ...
                    <div class="newsltr_bg" id="2nd_featured_back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px 0;">
                                ...
                                <div style="float: left; width: 100%; margin: 12px 0;">
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_2ndimg" data-id="2nd_ftr_2ndimg">
                                            <img id="ftr_2nd_2ndimge" src="../PostCardImages/featrd_img1_postcard3_1.jpg" alt="" title="" style="width: 100%; height:250px; border: 2px solid white;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_3rdimg" data-id="2nd_ftr_3rdimg">
                                            <img id="ftr_2nd_3rdimge" src="../PostCardImages/featrd_img1_postcard3_2.jpg" alt="" title="" style="width: 100%; height:250px; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_4thimg" data-id="2nd_ftr_4thimg">
                                            <img id="ftr_2nd_4thimge" src="../PostCardImages/featrd_img1_postcard3_3.jpg" alt="" title="" style="width: 100%; height:250px; border: 2px solid white;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_5thimg" data-id="2nd_ftr_5thimg">
                                            <img id="ftr_2nd_5thimge" src="../PostCardImages/featrd_img1_postcard3_4.jpg" alt="" title="" style="width: 100%;  height:250px; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_6thimg" data-id="2nd_ftr_6thimg">
                                            <img id="ftr_2nd_6thimge" src="../PostCardImages/featrd_img1_postcard3_5.jpg" alt="" title="" style="width: 100%; height:250px; border: 2px solid white;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_7thimg" data-id="2nd_ftr_7thimg">
                                            <img id="ftr_2nd_7thimge" src="../PostCardImages/featrd_img1_postcard3_6.jpg" alt="" title="" style="width: 100%; height:250px; border: 2px solid white;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; margin: 8px 0; text-align: center;">
                                        <img src="../PostCardImages/featurd_border2.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Sanjiv & Meena Aggarwal</h2>
                                <p style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 2px 0;">HomeLife/Miracle Realty Ltd., Brokerage</p>
                            </div>
                        </div>
                    </div>
                    <%--End Second featured card functionality--%>
                     <div style="float: right;margin-top: 10px;">
                          <asp:Button ID="btnSavePostcard3" class="btn btn-primary btnSavePostcard3" Text="Save" runat="server" OnClick="btnSavePostcard3_Click" />
                    </div>
                    ...
                    <div class="newsltr_bg" id="jst_sold_front" style="display: none">
                        <div style="float: left; width: 98%; background-color: #FFF; padding: 12px;">
                            ...
                            <div style="float: left; width: 100%;">
                                <img id="jsthold_1stimge" data-id="jsthold_1stimge" src="../PostCardImages/featurd_img1_Postcard4.png" alt="" title="" style="width:99%; height:350px;/>
                            </div>
                            <div style="float: left; width: 100%;">
                                ...
                                <div style="float: left; width: 100%;">
                                    ...
                                    <div style="float: left; width: 65%;">
                                        <div style="float: left; padding: 6px;">
                                            <h2 style="float: left; width: 100%; color: #b80a05; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0; border-bottom: 1px solid;">Sanjiv & Meena Aggarwal</h2>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 416-409-9090</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: realtor.aggarwal@gmail.com</p>
                                            <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.aggarwalrealty.ca/</p>
                                ...
                                <div style="float: left; width: 100%; margin: 4px 0;">
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_2ndimge" data-id="jsthold_2ndimge" src="../PostCardImages/featurd_img1_Postcard4_1.jpg" alt="" title="" style="width: 100%; height:200px; border: 2px solid white;" />
                                        ...
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_3rdimge" data-id="jsthold_3rdimge" src="../PostCardImages/featurd_img1_Postcard4_2.jpg" alt="" title="" style="width: 100%; height:200px; border: 2px solid white;" />
                                    ...
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_4thimge" data-id="jsthold_4thimge" src="../PostCardImages/featurd_img1_Postcard4_3.jpg" alt="" title="" style="width: 100%; height:200px; border: 2px solid white;" />
                                        ...
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_5thimge" data-id="jsthold_5thimge" src="../PostCardImages/featurd_img1_Postcard4_4.jpg" alt="" title="" style="width: 100%; height:200px; border: 2px solid white;" />
                                    ...
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_6thimge" data-id="jsthold_6thimge" src="../PostCardImages/featurd_img1_Postcard4_5.jpg" alt="" title="" style="width: 100%; height:200px; border: 2px solid white;" />
                                        ...
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_7thimge" data-id="jsthold_7thimge" src="../PostCardImages/featurd_img1_Postcard4_6.jpg" alt="" title="" style="width: 100%; height:200px; border: 2px solid white;" />
                    ...
                    <div style="float: right;margin-top: 10px;">
                          ...
                          <asp:Button ID="btnSavePostcard4" class="btn btn-primary btnSavePostcard4" Text="Save" runat="server" OnClick="btnSavePostcard4_Click" />
                    </div>
                                ...
                                <div class="modal-body modl_bg">
                                    ...
                                    <ul class="list_to_row">
                                        ...
                                        <li class="cell">
                                            ...
                                            <asp:FileUpload ID="openhousefile2" runat="server" onchange="showUsrImgpreview(this,'openhousefile2')" />
