...
namespace Property
{
    ...
    public class Newsletterfile : System.Web.Services.WebService
    {
        ...
        [System.Web.Services.WebMethod]
        [ScriptMethod(UseHttpGet = false)]
        public string FirstPostCard(string FirstContent, string SecondContent, string ThirldContent,string Desc)
        {
            string html = "";
            string Template = "";
        ...
        [System.Web.Services.WebMethod]
        [ScriptMethod(UseHttpGet = false)]
        public string SecondPostCard(string First_feature_cntnt, string Second_feature_cntnt, string Thirld_feature_cntnt, string Fourth_feature_cntnt, string Desc)
        {
            string html = "";
            string Template = "";
        ...
        [System.Web.Services.WebMethod]
        [ScriptMethod(UseHttpGet = false)]
        public string ThirldPostCard(string First_feature_cntnt, string Second_feature_cntnt, string Thirld_feature_cntnt, string Fourth_feature_cntnt, string Desc)
        {
            string html = "";
            string Template = "";
